          ...
          <div className={sectionContainer}>
            <div className="h-full flex flex-col items-center justify-center pt-20 pb-24 md:pt-36 md:pb-40">
              ...
              <div className="relative z-50">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl px-4 md:px-10 lg:px-20">To identify, invest in, and support the next generation of company leaders in retail technology.</h3>
              </div>
            </div>
          </div>
